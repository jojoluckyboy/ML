...
if __name__ == '__main__':
    ...
    dic_list = {}
    dic_result = {}
    reader = pd.read_csv('E:\\file1.txt',header=None,sep='：',dtype=str)
    # print reader[1].dtypes
    reader[1] = reader[1].astype(int)
    # print reader[1].dtypes
    # b = reader.sort_values(by=1, ascending=False).head(100)
    b = reader.sort_values(by=1, ascending=False)
    print b
